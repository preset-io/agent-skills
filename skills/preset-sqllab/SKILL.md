...
5. Load [references/guarded-sql-execution.md](references/guarded-sql-execution.md) before any SQL execution, result export, query stop, or saved query mutation.
