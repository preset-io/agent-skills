...
- **preset-workspaces** skill — List and inspect teams and workspaces; add, update, and remove workspace and team members; audit access.
- **preset-dashboards** skill — Create, retrieve, update, and delete dashboards; export/import dashboard bundles; embedded dashboard configuration; guest token generation.
