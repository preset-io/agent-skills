...
Before running a data-returning read on an unfamiliar workspace, confirm:
...
After the scope check, load [safety-policy.md](safety-policy.md) to record disclosure and redaction expectations.
